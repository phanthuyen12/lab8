...
<main ng-app="myApp" ng-controller = "shop">
    ...
    <div ng-repeat="category in categories">
        <div class="single-widget-category">
            <input type="checkbox" id="cat-item-@{{category.index}}" ng-model="category.selected" ng-change="getProductCategory(category.category_id)">
            <label for="cat-item-@{{category.index}}">@{{category.category_name}} <span>(@{{category.product_count}})</span></label>
        </div>
                            </div>
                            </div>
