                                ...
                                <div id="category-list">
                                    <div ng-repeat="category in categories">
                                        <div class="single-widget-category">
                                            <input type="checkbox" id="cat-item-@{{category.index}}"
                                                ng-model="category.selected"
                                                ng-change="getProductCategory(category.category_id)">
                                            <label for="cat-item-@{{category.index}}">@{{category.category_name}}
                                                <span>(@{{category.product_count}})</span></label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tp-wrapper">
                                <div class="row g-0">
                                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"
                                        ng-repeat="product in products | filter:searchTerm | filter:categoryFilter">
                                        <div class="product__item product__item-d">
                                            <div class="product__thumb fix">
                                                <div class="product-image w-img" style="width: 300px; height: 300px;">
                                                    <a href="product-details.html">
                                                        <img ng-src="/images/@{{ product.img_product }}" alt="product"
                                                            id="product-image" width="300px">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="product__add-cart-s text-center">
                                                ...
                                                <a href="/product-detail/@{{product.product_id}}"
                                                    class="cart-btn d-flex mb-10 align-items-center justify-content-center w-100">Xem
                                                    Ngay</a>
                                            </div>
                                        </div>
                                    </div>
