...
<link rel="stylesheet" href="{{ asset('client/css/backtotop.css') }}">
<link rel="stylesheet" href="{{ asset('client/css/magnific-popup.css') }}">
<link rel="stylesheet" href="{{ asset('client/css/nice-select.css') }}">
<link rel="stylesheet" href="{{ asset('client/flaticon/flaticon.css') }}">
<link rel="stylesheet" href="{{ asset('client/css/font-awesome-pro.css') }}">
